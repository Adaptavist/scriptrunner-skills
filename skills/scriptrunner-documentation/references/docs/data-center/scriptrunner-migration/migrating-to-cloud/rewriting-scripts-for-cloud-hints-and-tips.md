...
- Doc ID: doc-sr4js-441364598
- Source: https://docs.adaptavist.com/sr4js/latest/scriptrunner-migration/migrating-to-cloud/rewriting-scripts-for-cloud-hints-and-tips
...
1.  **List existing API calls**:
    ...
    -   Verify the purpose of each API call by checking the [Atlassian Jira REST API](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#about) documentation or using [Migration Tools](#id-.RewritingScriptsforCloudHintsandTipsv9.x-tools) mentioned above.  
...
For more details on APIs see the [Commonly used Atlassian Java API endpoints and their Cloud equivalents](#id-.RewritingScriptsforCloudHintsandTipsv9.x-common-api) section below.
...
For more details on implementation for basic operations see the [Common operations](#id-.RewritingScriptsforCloudHintsandTipsv9.x-common-operation) section below.

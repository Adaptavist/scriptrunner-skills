...
- Doc ID: doc-sr4c-9c8a00c8-3899-43fc-af9b-f627b32c2609-9f9e505572eed969
- Source: https://docs.adaptavist.com/sr4c/latest/integrations#atlassian--en#remote-control--en
...
Tip: When you use code like `.each { …​ }` the part in the brackets is a _closure_.
...
Tip: If you don't read any further, just pass around strings, numbers, dates, etc or _Collections_ thereof.
...
Tip: As in the example above, the `.exec()` method can take multiple closures, not just one. If used like this the returned value(s) of each closure are passed to the next one. This is a good way of reusing code, as with _remote control_ you cannot call a method defined in the script, outside of the closure.

...
- Space: SR4CC
- Hierarchy: features
- Doc ID: doc-sr4cc-107988349
- Source: https://docs.adaptavist.com/sr4cc/latest/features/built-in-scripts
...
-   [Confluence Administration Built-In Script](https://docs.adaptavist.com/sr4cc/latest/features/built-in-scripts/confluence-administration-built-in-script)
-   [Space Administration Built-In Scripts](https://docs.adaptavist.com/sr4cc/latest/features/built-in-scripts/space-administration-built-in-scripts)
...
The number of available built-in scripts you have depends on what version of ScriptRunner for Confluence Cloud you are running. Please visit the [Developer Documentation](https://developer.atlassian.com/cloud/confluence/about-confluence-cloud/) for more information.

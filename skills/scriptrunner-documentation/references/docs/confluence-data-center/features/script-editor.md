...
- Space: SR4C
- Hierarchy: Features
- Doc ID: doc-sr4c-0f4ff452-cef5-4312-9c96-1f263cad2d95-4be714aab4d813a4
- Source: https://docs.adaptavist.com/sr4c/latest/features#script-editor--en

Learn about the Script Editor, which allows you to manage Groovy files and folders.
...
3.  Select the Save button when you have finished editing.
    ...
    Note: Changes are not saved automatically. When there are unsaved changes to your script, the Save button is present. When all changes are saved, the Saved button replaces the Save button. To delete a .groovy file, click the Delete button.

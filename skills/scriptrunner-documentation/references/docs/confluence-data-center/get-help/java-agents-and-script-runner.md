# Java Agents and ScriptRunner

- Platform: confluence-data-center
- Space: SR4C
- Hierarchy: Get Help
- Doc ID: doc-sr4c-247c1a92-d12e-43bd-ba26-b1ae148005e5-70b659ec28c5a7a7
- Source: https://docs.adaptavist.com/sr4c/latest/get-help#java-agents-and-scriptrunner--en

Information to help with potential problems between Java Agents and the ScriptRunner app.
...
To better help our customers keep their Atlassian apps running, we have compiled what we know about Java monitoring agents. Please note that the implementation details of different Java monitoring agents will vary, and we can't realistically keep up with the many details.

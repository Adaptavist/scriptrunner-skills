...
- Doc ID: doc-sr4c-831e5a99-3671-4b36-a020-97d5d0e891a4-17daa98a4800340c
- Source: https://docs.adaptavist.com/sr4c/latest/features#built-in-scripts--en#space-administration-built-in-scripts--en#copy-pages--en
...
3.  Select Copy Pages.
4.  Enter a space in Source Space to select the space the page tree is copied from.
5.  Select the checkbox next to the page tree or pages you want to work with for Source Pages.
6.  Enter a space in Target Space to select the page the information is copied to.
7.  Select a checkbox next to the page that you want the information to be copied to in Target Page.
8.  Enter the text you want at the beginning of the title in Title Prefix.
9.  Enter the text you want at the end of the title in Title Suffix.
10.  Use Title Replace to find and replace words in a title when copying.
     
     Note: To copy a page within the same space, manipulate the titles with a groovy closure because titles must be unique.
     
11.  Use the checkboxes for Inline Comments and Page Comments to choose to copy that content with the pages.
12.  Use the Notifications checkbox to send notifications for the update.
13.  Use Code Transform to transform parts of the Confluence page with custom code.
14.  Select Run.
...
2.  Select Advanced Space Functionality.
3.  Select Copy Pages.
4.  Enter Your Documentation for Source Space.
5.  Select Version 1 in the Source Pages page tree.
6.  Enter Your Documentation Version 2 in Target Space.
7.  For Title Replace, enter Version 1 in the first field and Version 2 in the second field.
8.  Select Run.

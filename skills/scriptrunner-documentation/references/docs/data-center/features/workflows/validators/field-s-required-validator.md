...
- Doc ID: doc-sr4js-280526887
- Source: https://docs.adaptavist.com/sr4js/latest/features/workflows/validators/field-s-required-validator
...
This validator must be applied to a transition with a [screen](https://confluence.atlassian.com/adminjiraserver0820/defining-a-screen-1095777068.html). When completing this validator, only fields configured in the associated transition screen are listed in the **Required Field(s)** drop-down.
...
![Image example of a screen attached to a transition](/sr4js/files/latest/280526887/280526883/1/1724057611000/Screen_example.png)
...
You can use our Behaviours feature to [make a field required based on a condition](https://docs.adaptavist.com/sr4js/latest/features/behaviours/behaviours-examples/field-required#field-required). This will display the red asterisk however this option is not transition-dependent. 
...
4.  Under **Options**, select **Validators.  
    ![](/sr4js/files/latest/280526887/280526884/1/1724057611000/Fields_changed_validator_2.png)  
    **
5.  On the _Transition_ page, select **Add validator**.
6.  Select **Field(s) required validator**.  
    ![Image of the validator selected](/sr4js/files/latest/280526887/280526878/1/1724057611000/Fields_req_v_logo.png)  
...
12.  Select **Publish** and choose if you want to save a backup copy of the workflow.  
     ![Image with Publish option highlighted](/sr4js/files/latest/280526887/280526881/1/1724057611000/Require_comment_4.png)
     ...
     ![Image showing an example of the error](/sr4js/files/latest/280526887/280526879/1/1724057611000/Field_required_error_2.png)

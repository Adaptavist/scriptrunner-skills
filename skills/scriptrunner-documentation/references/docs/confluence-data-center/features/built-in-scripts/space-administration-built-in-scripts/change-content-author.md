...
- Doc ID: doc-sr4c-bb0f783d-6224-4133-be58-03b36240d331-81e0f22bc52a1a84
- Source: https://docs.adaptavist.com/sr4c/latest/features#built-in-scripts--en#space-administration-built-in-scripts--en#change-content-author--en
...
Once you select Run, the Result of the script appears in a bulleted list letting you know what was updated
...
3.  Select Change Content Author.
4.  For CQL Query, enter space = DP AND label = product\_roadmap.
5.  For New Author, enter tech\_lead.
6.  Select Run.
